    ...
    private void viewKeepersButtonController() {
        ...
        adminDash.getViewKeeperButton().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                view.setViewKeepers(new ViewKeepersFrame(model.getListKeepers(), "Admin - View Keeper", 730, 460, "src/cctzoo/view/images/animal.png"));
                ctrl.getViewKeepersCtrl().setViewKeepers(view.getViewKeepers());

                //view.setViewKeepers(viewKeepers);
                viewKeepers = view.getViewKeepers();
                adminDash.dispose();
