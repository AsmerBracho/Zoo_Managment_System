...
public class UpdateKeeperFrame extends MainFrame {
    ...
    public UpdateKeeperFrame(String frameTitle, int frameWidth, int frameHeight, String iconName) {
        ...
        this.animalsPanel = new ViewAnimalsPanel(15, 235, 500, 360, "Animals that keeper is qualified to look after", "Animals that keeper is qualified to look after", 330);
        ...
        this.viewAnimalsOnFrame = new ImageLabel(535, 245, 400, 340, "src/cctzoo/view/images/placeholder.png");
    ...
    private void setUpdateKeeperImage() {
        ...
        ImageIcon imgL = new ImageIcon("src/cctzoo/view/images/updatekeeper.png");
    ...
    private void setGoBackButton() {
        ImageIcon exitIcon = new ImageIcon("src/cctzoo/view/images/back.png");
    ...
    private void setUpdateImageLabel() {
        ...
        ImageIcon imgL = new ImageIcon("src/cctzoo/view/images/update.png");
        Image img = imgL.getImage();
    ...
    private void setUpdateKeeperButton() {
        ImageIcon exitIcon = new ImageIcon("src/cctzoo/view/images/updateanimal.png");
        Image imgExit = exitIcon.getImage();
    ...
    private void setAddAnimalToKeeperButton() {
        ImageIcon exitIcon = new ImageIcon("src/cctzoo/view/images/addanimal.png");
        Image imgExit = exitIcon.getImage();
        Image newImgExit = imgExit.getScaledInstance(MainFrame.xCoordinate(24), MainFrame.yCoordinate(24), Image.SCALE_SMOOTH);
        ImageIcon newExitIcon = new ImageIcon(newImgExit);
    ...
    public ImageLabel getViewAnimalsOnFrame() {
        return viewAnimalsOnFrame;
    }
